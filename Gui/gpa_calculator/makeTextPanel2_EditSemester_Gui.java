...
public class makeTextPanel2_EditSemester_Gui extends JPanel {
	...
	public makeTextPanel2_EditSemester_Gui(String text) {
		...
		BufferedImage buttonIcon2 = EditSemester_Gui.resize(buttonIcon, 20, 20);
		...
		BufferedImage buttonIcon4 = EditSemester_Gui.resize(buttonIcon3, 20, 20);
