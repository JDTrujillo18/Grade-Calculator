...
public class GPA_Gui extends JPanel {
	...
	protected static JComponent makeTextPanel(String text) {
		...
		fillerClass1.addMouseListener(new PopClickListener());
		...
		fillerClass2.addMouseListener(new PopClickListener());
		...
		fillerClass3.addMouseListener(new PopClickListener());
		...
		fillerClass4.addMouseListener(new PopClickListener());
		...
		fillerClass5.addMouseListener(new PopClickListener());
		...
		fillerClass6.addMouseListener(new PopClickListener());
		...
		fillerClass7.addMouseListener(new PopClickListener());
		...
		fillerClass8.addMouseListener(new PopClickListener());
